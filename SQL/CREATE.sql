...
BEGIN
  ...
  THEN
    RAISE_APPLICATION_ERROR( -20001, 
          'B³êdna data urodzenia: Data w polu data urodzenia musi byæ mniejsza lub równa aktualnej:' );
  END IF;
END;
/
...
BEGIN
  ...
  THEN
    RAISE_APPLICATION_ERROR( -20002, 
          'B³êdna data wizyty: Data w polu data wizyty musi byæ wiêksza lub równa aktualnej:' );
  END IF;
END;
/
...
BEGIN
  ...
  THEN
    RAISE_APPLICATION_ERROR( -20004, 
          'B³êdna data wa¿noœci: Data w polu data wa¿noœci musi byæ wiêksza lub równa aktualnej:' );
  END IF;
END;
/